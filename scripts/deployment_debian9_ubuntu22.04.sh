...
sudo apt install -y nginx build-essential gcc git htop libbz2-dev libcurl4-openssl-dev libffi-dev liblzma-dev libssl-dev libxml2-dev make python3 python3-dev python3-venv python3-wheel python3-pip sudo zip zlib1g zlib1g-dev rabbitmq-server python3-venv python3-lxml 
#zlibc
