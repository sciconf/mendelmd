...
RUN	apt-get install -y \
	...
	pkg-config python-dev python-lxml python python-dev python3-pip python3 python3-dev python3-pip python3-setuptools python3-venv rabbitmq-server dh-python \
...
#RUN cd pynnotator && python3 setup.py develop && pynnotator install
